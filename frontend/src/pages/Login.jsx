                    ...
                    >
                        <div className="mb-6 text-center">
                            <h2 className="text-3xl font-display font-bold tracking-tight text-white mb-2">
                                Welcome <span className="text-[#F25623]">Back.</span>
                            </h2>
                            <p className="text-xs text-[#A3A3A3] font-medium leading-relaxed">
                                Access your workspace. Initialize your surgical assessment protocol.
                            </p>
                        </div>

                        <div className="glass-card p-6 md:p-8 rounded-xl border-[#1F1F1F] relative bg-[#000000]/80 backdrop-blur-md shadow-2xl">
                            {message && (
                                <div className="mb-6 p-3 rounded-xl bg-[#F25623]/10 border border-[#F25623]/20 text-[#F25623] text-[10px] font-bold text-center uppercase tracking-widest">
                                    {message}
                                </div>
                            )}
                            ...
                            <form onSubmit={handleLogin} className="space-y-5">
                                <div className="space-y-4">
                                    <div>
                                        <label className="text-[10px] font-bold text-[#A3A3A3]/60 uppercase tracking-widest mb-2 block ml-1">E-mail Address</label>
                                        <Input
                                            placeholder="name@company.com"
                                            value={identifier}
                                            onChange={(e) => { setIdentifier(e.target.value); setError(''); }}
                                            className="h-11 bg-[#050505] border-[#1F1F1F] focus:border-[#F25623]/40 rounded-[6px]"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <div className="flex justify-between items-center px-1 mb-2">
                                            <label className="text-[10px] font-bold text-[#A3A3A3]/60 uppercase tracking-widest block">Password</label>
                                            <button type="button" className="text-[10px] font-bold text-[#F25623] hover:text-[#F25623]/80 uppercase tracking-widest transition-colors">Forgot?</button>
                                        </div>
                                        <div className="relative">
                                            <Input
                                                ...
                                                className="h-11 bg-[#050505] border-[#1F1F1F] focus:border-[#F25623]/40 rounded-[6px] pr-12"
                                                required
                                            />
                                            <button 
                                                type="button"
                                ...
                                <Button 
                                    type="submit" 
                                    className="w-full h-11 bg-white text-black hover:bg-white/90 shadow-2xl flex items-center justify-center gap-3 rounded-[6px] font-bold text-xs"
                                    disabled={loading}
                                >
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-[10px] text-[#A3A3A3]/60 font-bold uppercase tracking-widest">
                                New to the network?{' '}
                                <Link to="/register" className="text-white hover:text-[#F25623] transition-all ml-1">
                                    Request Access
                                </Link>
                            </p>
                        </div>
